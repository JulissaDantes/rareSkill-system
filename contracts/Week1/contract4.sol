...
/// @dev A contract where a buyer can put an *arbitrary* ERC20 token into a contract and a seller can withdraw it 3 days later.
contract Contract4 {
    ...
    /// @dev Returns the total amount of tokens sent to an address
    ...
    /// @dev Allows to send tokens to recipient for the contract to hold for 3 days minimun
    /// @param target The recipient of the funds
    ...
    /// @dev Allows to withdraw locked tokens if the time is up
    ...
    /// @dev Manipulates the tokens available in time by adding or removing
